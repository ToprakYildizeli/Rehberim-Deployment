# Generated by Django 6.0.6 on 2026-07-09 12:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade', models.CharField(choices=[('9', '9. Sınıf'), ('10', '10. Sınıf'), ('11', '11. Sınıf'), ('12', '12. Sınıf'), ('mezun', 'Mezun')], default='12', max_length=5)),
                ('study_field', models.CharField(blank=True, choices=[('say', 'Sayısal'), ('ea', 'Eşit Ağırlık'), ('soz', 'Sözel')], max_length=3, null=True, verbose_name='Alan')),
                ('counselor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='accounts.counselor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, related_name='parents', to='accounts.student', verbose_name='Öğrenciler')),
            ],
            options={
                'verbose_name': 'Veli',
